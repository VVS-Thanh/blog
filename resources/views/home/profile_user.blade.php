                    ...
                    <div class="profile-main pt-0">
                        ...
                        <div class="list_blog">
                            ...
                            <div class="list_blog_me">
                                <div class="infor_post_user">
                                    <span>Tổng số bài viết</span>
                                    <span>@{{ me.posts.length }}</span>
                                    <!-- <span> -- </span>
                                            <span>Tổng số lượt like</span>
                                            <span>@{{ me.posts.length }}</span> -->
                                </div>
            ...
            let app = new Vue({
                ...
                methods: {
                    ...
                    getMe() {
                        ...
                        axios.get(`http://blog.com/api/users/` + vm.id_user, {
                                // headers: headers,
                                // token: vm.token,
                            })
                            .then(response => {
                                ...
                                //     return {
                                //         contents: vm.extractContent(value.contents).substring(0, 100) + "[...]",
                    ...
                    getAllPostUser() {
                        ...
                        axios.get(`http://blog.com/api/users/` + vm.id_user, {
                            ...
                            .then(response => {
                                console.log(response.data);
                                console.log('new123', response.data);

                                vm.list_format_all_post = response.data.posts;
                                // console.log(vm.list_format_all_post);
                                vm.list_all_posts = vm.list_format_all_post.map((value, index) => {
                                    return {
