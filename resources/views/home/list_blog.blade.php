...
@endsection
@section('content')
    <section style="padding: 0px; padding-top: 80px" id="list_blog" class="list_blog_cover ">
                    ...
                    <div v-for="(item,index) in list_all_posts" class="list_main_blog ">
                        <div class="blog_card">
                            ...
                            <div class="blog_card_left">
                                <img style="cursor: pointer" @click="viewMoreDetail(item.id)" :src="item.thumbnail_image"
                                    alt="">
                            </div>
                            <div class="blog_card_right">
                                <div class="blog_card_right_user">
                                    <img src="images/layout/logo.png" alt="avatar">
                                    <span class="blog_card_right_user_name">name</span>
                                    <span class="blog_card_right_user_created" v-text="item.created_at">ngày thêm
                                        vào</span>
                                </div>
                                <div class="blog_card_right_detail">
                                    ...
                                    <span @click="viewMoreDetail(item.id)" class="blog_card_right_detail_title"
                                        v-text="item.topic"></span>
                                    <span @click="viewMoreDetail(item.id)" class="blog_card_right_detail_content"
                                        v-text="item.contents"></span>
                                </div>
                            </div>
                            <div class="btn-group btn-list-data-group">
                                <button type="button" class="btn dropdown-toggle btn-data-toggle" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    Action
                                </button>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item " @click="redirectEditPage(item.id)" href="#">Sửa</a>
                                    <div class="dropdown-divider"></div>
                                    <div @click="pushId(item.id)" data-toggle="modal" data-target="#deleteModal"
                                        class="dropdown-item ">Xóa</div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" @click="delete_post(id)" class="btn btn-primary">Save
                                                changes</button>
                                        </div>
                                    </div>
                                </div>
